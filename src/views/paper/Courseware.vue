    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                <el-form-item>
                    <el-input v-model="filters.searchVal" placeholder="课件名称/描述"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <el-table :data="papers" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="paperName" label="课件名称" sortable>
            </el-table-column>
            <el-table-column prop="paperDesc" label="课件描述" sortable>
            </el-table-column>
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                <el-form-item label="课件名称" prop="paperName">
                    <el-input v-model="editForm.paperName" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="课件描述" prop="paperDesc">
